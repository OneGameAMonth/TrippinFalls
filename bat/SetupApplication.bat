...
:: Android packaging
set AND_CERT_NAME="TrippinFalls"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TrippinFalls.p12
...
set IOS_PROVISION=cert\TrippinFalls.mobileprovision
...
set APP_ID=air.TrippinFalls

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TrippinFalls
